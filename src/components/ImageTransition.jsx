  ...
  export const ImageTransition = (props) => {
   ...
   return(
     <Box style={{position:'relative'}}  w={props.width} h={props.height} 
       ...
       <Flex id={props.unitid} className="normal" style={{background:props.border2, position:"absolute"}} w='100%' h='100%' rounded={props.rounded}>
         <Flex style={{background:props.background2}} w='100%' m='2px' rounded={props.rounded}>
         </Flex>
       </Flex>
